...
"%EXECUTABLE%" //US//%SERVICE_NAME% --Startup auto --JvmOptions "-XX:MaxPermSize=256m;-Dcatalina.base=%CATALINA_BASE%;-Dcatalina.home=%CATALINA_HOME%;-Djava.endorsed.dirs=%CATALINA_HOME%\common\endorsed" --StartMode jvm --StopMode jvm
