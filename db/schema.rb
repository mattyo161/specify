...
ActiveRecord::Schema.define(:version => 20111007035625) do
  ...
  create_table "aim_templates_template_containers", :id => false, :force => true do |t|
    t.integer  "aim_template_id",       :null => false
    t.integer  "template_container_id", :null => false
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "bp_ontologies", :force => true do |t|
    t.string   "name"
  ...
  create_table "bp_properties", :force => true do |t|
  ...
  create_table "bp_terms", :force => true do |t|
    t.string   "name"
    t.string   "bpid"
    t.integer  "bp_ontology_id"
    t.datetime "created_at"
  ...
  create_table "bp_triples", :force => true do |t|
    t.integer  "domain"
    t.string   "property"
    t.integer  "range"
    t.datetime "created_at"
